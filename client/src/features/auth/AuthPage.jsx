      ...
      <section className="auth-panel">
        <div className="auth-box">
          ...
          <Reveal>
            ...
            <h2>{signup ? "Begin your journey." : "Welcome back."}</h2>
            <p className="muted">
              Your session is secured by an HTTP-only cookie.
            </p>
          </Reveal>
          <form onSubmit={submit}>
            ...
            <button className="luxury-button" disabled={busy}>
              {busy ? (
                "Authenticating…"
              ) : signup ? (
                <>
          ...
          <p className="auth-switch">
            {signup ? "Already registered?" : "New to MERN SKILLS?"}{" "}
