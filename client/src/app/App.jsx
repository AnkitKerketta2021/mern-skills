...
const UnauthorizedPage = lazy(
  () => import("../features/pages/UnauthorizedPage"),
);
const ProfileSettingsPage = lazy(
  () => import("../features/profile/ProfileSettingsPage"),
);
const AdminUsersPage = lazy(() => import("../features/admin/AdminUsersPage"));
const AdminDashboardsPage = lazy(
  () => import("../features/admin/AdminDashboardsPage"),
);
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route
                ...
                element={
                  <ProtectedComingSoon
                    eyebrow="LEARNINGS"
                    title="Top Concepts coming soon"
                  />
                }
              />
              <Route
